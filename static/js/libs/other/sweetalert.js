...
var setParameters = function setParameters(params) {
  ...
  var iconDebug = sweetContainer.querySelector('.icon-debug');
  if(params.debug){
  	iconDebug.style.display = 'block';
	iconDebug.setAttribute('data-config',params.errorInfo);
	}else{
		iconDebug.style.display = 'none';
	}
  // Title
  ...
  // Buttons styling
  if (params.buttonsStyling) {
    addClass(confirmButton, params.btnConfirmClass);
    addClass(cancelButton, params.btnCancelClass);
  } else {
    removeClass(confirmButton, params.btnConfirmClass);
    removeClass(cancelButton, params.btnCancelClass);
