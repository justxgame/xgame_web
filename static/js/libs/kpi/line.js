...
define(['angular', 'require','local','echarts'],function(angular, require,local,echarts){
	...
	/*获取线图 需要的参数*/
	var getline =  function getline(data,param){
			var cfg = param['cfg'];
			var type = param['type'];
			...
			return getlinechart(legend['data'],xAxis,series);
	}
	...
	/*最终结果集*/
	var getlinechart = function (legend,xAxis,series) { 
			return option = {
					tooltip: {
						trigger: 'axis'
					},
