	...
	1: [
		...
		function(require, module, exports) {
			...
			(function() {
				...
				var _elementInit = function(mainElement) {
					//					if (!ZeroClipboard.prototype._singleton) return;
					var target;
					target = mainElement;
					alert(123231);
				...
				ZeroClipboard.prototype.glue = function(elements, mobile) {
					mainElement = elements = _prepGlue(elements);
		...
		function(require, module, exports) {
			...
			$.fn.zclip = function(options) {
				...
				if ($.isPlainObject(options)) {
					...
					if (clip) {
						clip.glue(this, settings.mobile);
					} else {
					...
					clip.on('complete', function(client, args) {
						...
						if ($.isFunction(settings.afterCopy)) {
							...
							global.alert(settings.alertTxt);
						}
