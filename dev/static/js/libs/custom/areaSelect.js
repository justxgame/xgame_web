define(function() {
	...
	return {
		init:function(ddlProvince,ddlCity){
			this.ddlProvince=document.getElementById(ddlProvince);
			this.ddlCity = document.getElementById(ddlCity);
		},
		BindProvince: function() {
			var opt0 = "省份";
			var ProvinceCount = china.length;
			var ddlProvince = this.ddlProvince;
		...
		BindCity: function(City) {
			console.log(City)
			
			var ProvinceCount = china.length;
			var ddlProvince = this.ddlProvince;
			var ddlCity = this.ddlCity;
			...
			for (var i = 0; i < ProvinceCount; i++) {
				...
				if (flag && chose) {
					...
					console.log(ddlProvince.options[i + 1].value);
					chose = false;
				}
			}
